...
Tested on Ubuntu (primary target); works anywhere the `tesseract` CLI is installed (Linux, macOS, Windows). Verified against dsh `0.1.1-rc.1`.
...
> `- insert:` row with the same id to your profile — dsh `0.1.1-rc.1`
